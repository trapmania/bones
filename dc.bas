'----------------------------------------------
'program purpose: .............................
'.....a standalone simple draggable circle.....
...
'if you are to include the object in your code
'don't include anything below, it's just demo

'----------------------------------------------
'--------------------------------INITIALIZATION

'           set up a graphical screen
'           -------------------------
'if no graphical screen, 
'a default one is opened by the udt constructor

'set up an instance of default DRAGGABLECIRCLE
dim as DRAGGABLECIRCLE defaultDraggableCircle

'set up some non-default DRAGGABLECIRCLE
dim as integer	initialXposition	=> 080
dim as integer	initialYposition	=> 080
dim as integer	circleRadius		=> 004
dim as ulong	circleBorderColor	=> rgb(100,200,100)
dim as string	draggableCircleName	=> "Example"
dim as DRAGGABLECIRCLE draggableCircleExample => _ 
DRAGGABLECIRCLE( initialXposition, _ 
				 initialYposition, _ 
				 circleRadius, _ 
				 circleBorderColor, _ 
				 draggableCircleName)
...
do 
    ...
    screenLock
    cls
    defaultDraggableCircle.DrawDraggablePoint()
    draggableCircleExample.DrawDraggablePoint()
    screenUnlock
    '
    sleep 15
